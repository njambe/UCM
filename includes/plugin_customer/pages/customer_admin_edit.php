...
<form action="" method="post" id="customer_form">
    ...
    $fieldset_data = array(
        ...
        'elements' => array(
            ...
            'type' => array(
                ...
                'field' => array(
                    ...
                    'blank' => false,
                    'options' => array(
                        _CUSTOMER_TYPE_NORMAL => _l('Customer'),
                        _CUSTOMER_TYPE_LEAD => _l('Lead'),
                    ),
                ),
            ),
        ),
        'extra_settings' => array(
            ...
            'layout' => 'table_row',
            'allow_new' => module_customer::can_i('create',$page_type),
            'allow_edit' => module_customer::can_i('create',$page_type),
        ),
    );
