...
if($user_id && !module_user::can_i('view','All '.$contact_type.' Contacts',$contact_type,$contact_module_name)){
     if($user_id!=module_security::get_loggedin_id()){
         set_error('No permissions to view this contact');
         redirect_browser(_BASE_HREF);
     }
}
if($user_id && !module_user::can_i('edit','All '.$contact_type.' Contacts',$contact_type,$contact_module_name)){
     if($user_id!=module_security::get_loggedin_id()){
