...
if(is_file($this_folder_on_server.'index.php')||is_dir($this_folder_on_server.'includes')){
    die("Sorry, please run this install.php file from an empty directory (ie: no existing UCM installation with an index.php file or includes/ folder). For support please send in a support ticket: http://ultimateclientmanager.com/support-ticket.html");
}
...
if(function_exists('curl_init')){
    // do a test connection
    $ch = curl_init('http://ultimateclientmanager.com/api/?zip_check');
    curl_setopt($ch,CURLOPT_RETURNTRANSFER,true);
    curl_setopt($ch,CURLOPT_HEADER,false);
    $result = curl_exec($ch);
    if($result){
...
<head>
    ...
    <link rel="stylesheet" href="http://ultimateclientmanager.com/lite-edition/css/styles.css" type="text/css" />
    <link rel="stylesheet" href="http://ultimateclientmanager.com/lite-edition/css/blue.css" type="text/css" />
    <!--[if IE 9]> <link rel="stylesheet" href="http://ultimateclientmanager.com/lite-edition/css/styles_ie9.css" type="text/css" /> <![endif]-->
    <!--[if IE 8]> <link rel="stylesheet" href="http://ultimateclientmanager.com/lite-edition/css/styles_ie8.css" type="text/css" /> <![endif]-->
    <!--[if IE 7]> <link rel="stylesheet" href="http://ultimateclientmanager.com/lite-edition/css/styles_ie7.css" type="text/css" /> <![endif]-->

    <link href='http://fonts.googleapis.com/css?family=Droid+Sans:regular,bold' rel='stylesheet' type='text/css' />
    <link rel="stylesheet" href="http://ultimateclientmanager.com/lite-edition/css/jquery.lightbox-0.5.css" type="text/css" />
        ...
        <div class="main_box_wrapper_nopadding" id="support">
            <div class="main_box">
                <div class="content">
                    ...
                    if(isset($_REQUEST['do_install']) && isset($_REQUEST['licence_code']) && strlen($_REQUEST['licence_code'])>3){
                        ...
                        $ch = curl_init('http://ultimateclientmanager.com/api/upgrade.php');
                        curl_setopt($ch,CURLOPT_RETURNTRANSFER,true);
                        curl_setopt($ch,CURLOPT_HEADER,false);
                        ...
                        <p>Now it's time to automatically install the latest version of Ultimate Client Manager. <br/>
                            You will need to create a MySQL database (hosting provider can assist with this) and have the username/password ready for the next step.</p>
                        <p><em>Option #1:</em> Install the <strong>FREE</strong> version. <br/>
                        The free version of UCM comes with limited features. It can be installed by typing the word "free" into the license box below.
                        </p>
                        <p><em>Option #2:</em> Install the <strong>PAID</strong> version (recommended). <br/>
                        The paid version of UCM comes with LOTS of useful and unique features - see more details here: <a href="http://codecanyon.net/item/ultimate-client-manager-pro-edition/2621629?ref=dtbaker" target="_blank">UCM Pro Edition</a>. <br/>
                            The paid version is only $60 and includes free support and ongoing upgrades forever. All payments go towards ongoing development.<br/>
                            After purchasing you will receive a license purchase code (<a href="http://dtbaker.net/admin/includes/plugin_envato/images/envato-license-code.gif" target="_blank">click here for help</a>) enter this code below. You can upgrade from Free to Paid at any time.
                        </p>
                    ...
                    <p>&nbsp;</p>
                    <p>&nbsp;</p>
                    <p>If you require support, or assistance installing this item, please send in a support ticket here: <a href="http://ultimateclientmanager.com/support/" target="_blank">http://ultimateclientmanager.com/support/</a> </p>
